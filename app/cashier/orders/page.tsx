      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Today's sales history</p>
                </div>
              </div>
              <button
                onClick={fetchOrders}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card className="border border-gray-200">
              <CardContent className="p-6">
                <div className="inline-flex p-3 rounded-lg bg-orange-50 text-orange-600 mb-4">
            ...
            <Card className="border border-gray-200">
              <CardContent className="p-6">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-1">{stats.revenue.toFixed(0)}</p>
              </CardContent>
            </Card>
          </div>
                    ...
                    <tbody>
                      {filteredOrders.map((order) => (
                        <tr key={order._id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                          ...
                          <td className="py-4 px-4">
                            <span className="text-sm text-gray-700">{order.waiterName || `Batch ${order.waiterBatchNumber}`}</span>
                          </td>
                          <td className="py-4 px-4">
